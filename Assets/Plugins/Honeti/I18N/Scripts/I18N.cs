...
namespace Plugins.Honeti.I18N.Scripts
{
    ...
    public class I18N : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField] private LanguageCode _gameLang = LanguageCode.EN;
        ...
        /// </summary>
        [SerializeField] private bool _useCustomFonts = false;
        ...
        /// </summary>
        [SerializeField] private List<I18NFonts> _langFonts;
