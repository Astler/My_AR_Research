    ...
    public class WalkaboutActor : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (Rolling)
            {
                ...
                //UpdateSnowballScaleByDeltaTime();
        ...
        // Snowball scale/progress is spent on time spent in the walking state.
        public void UpdateSnowballScaleByDeltaTime()
        {
        ...
        public void IncrementProgress(float delta)
        {
            ...
            float endProgress = Mathf.Clamp01(progress + delta);
            Debug.Log("Incrementing yeti snowball progress from " + startProgress + " to " + endProgress);
            InterpolationUtil.EasedInterpolation(this, this, InterpolationUtil.EaseOutCubic, onUpdate: (t) =>
            {
                progress = Mathf.Lerp(startProgress, endProgress, t);
                UpdateSnowballScale();
            });
        }
