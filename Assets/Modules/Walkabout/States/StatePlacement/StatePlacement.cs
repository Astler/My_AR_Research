...
{
    /// <summary>
    /// State in Walkabout that activates the camera reticle with ghosted Doty to be placed, 
    /// and activates a placement button on the HUD,
    /// and instructs the player to click the button to place Doty on the gameboard.
    ...
    public class StatePlacement : StateBase
    {
        ...
        void OnEnable()
        {
            ...
            walkaboutManager.inStatePlacement = true;
        ...
        private void OnEventPlacementButton()
        {
            ...
            if (!walkaboutManager.cameraReticle.isValidPlacementPt) return;
        ...
        private IEnumerator ExitRoutine(GameObject nextState)
        {
            ...
            walkaboutManager.inStatePlacement = false;
