...
namespace Niantic.ARDK.Templates
{
  public class WayspotAnchorTemplateController : MonoBehaviour
  {
    ...
    private readonly Dictionary<Guid, GameObject> _wayspotAnchorGameObjects = new();
    ...
    private void Update()
    {
      ...
      Debug.Log($"_wayspotAnchorService.LocalizationState = {_wayspotAnchorService.LocalizationState}");
      Debug.Log($"_wayspotAnchorService = {_wayspotAnchorService.LocalizationFailureReason}");
