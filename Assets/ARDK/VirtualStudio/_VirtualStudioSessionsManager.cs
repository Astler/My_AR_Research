...
{
  internal sealed class _VirtualStudioSessionsManager:
    _IVirtualStudioSessionsManager
  {
    public const string LOCAL_PLAYER_NAME = "LocalPlayer";

    public static _IVirtualStudioSessionsManager Instance
    {
      get
      {
        ...
        lock (_instanceLock)
          if (_instance == null)
            _instance = new _VirtualStudioSessionsManager();
    ...
    private static _VirtualStudioSessionsManager _instance;
    ...
    readonly Dictionary<Guid, string> _arSessionIdentifierToPlayerName =
    ...
    private _VirtualStudioSessionsManager()
    {
    ...
    {
      ARLog._Error("VirtualStudioSessionsManager was not correctly disposed.");
    }
