...
namespace Niantic.ARVoyage
{
    ...
    public class SegmentedAudioLoop
    {
        ...
        {
            SegmentedAudioLoop loop = new(audioManager, audioKeyIn, audioKeyLoop, audioKeyOut, volume, stopCrossFadeDuration);
            loop.Start();
            return loop;
        }
        ...
        private SegmentedAudioLoop(AudioManager audioManager, string audioKeyIn, string audioKeyLoop, string audioKeyOut, float volume, float crossFadeDuration)
        {
            ...
            AudioKeyIn = audioKeyIn;
            AudioKeyLoop = audioKeyLoop;
            AudioKeyOut = audioKeyOut;
            Volume = volume;
            StopCrossFadeDuration = crossFadeDuration;
        }
